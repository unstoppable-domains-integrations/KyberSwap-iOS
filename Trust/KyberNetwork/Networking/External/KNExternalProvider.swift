...
class KNExternalProvider {
  ...
  fileprivate func estimateGasLimit(from: Address, to: Address?, gasPrice: BigInt, value: BigInt, data: Data, defaultGasLimit: BigInt, completion: @escaping (Result<BigInt, AnyError>) -> Void) {
